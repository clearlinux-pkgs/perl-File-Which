...
Source0  : https://cpan.metacpan.org/authors/id/P/PL/PLICEASE/File-Which-1.24.tar.gz
...
%prep
%setup -q -n File-Which-1.24
cd %{_builddir}
tar xf %{_sourcedir}/libfile-which-perl_1.21-1.debian.tar.xz
cd %{_builddir}/File-Which-1.24
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/File-Which-1.24/deblicense/
...
cp %{_builddir}/File-Which-1.24/LICENSE %{buildroot}/usr/share/package-licenses/perl-File-Which/9e9c2342163676b67e70ae492b987da7325f2747
